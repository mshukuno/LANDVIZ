                                ...
                                if os.path.isfile(metadataExtensionFilePath):
                                    ...
                                    if xmlQuery:
                                        ...
                                        if PROJECT[PROJECT.lastIdx].rasterOutputCellSize is None:
                                            PROJECT[PROJECT.lastIdx].rasterOutputCellSize = float(xmlQuery[0][CONFIG['ATTRIB']['RASTERCELLSIZE']])
                                        
                                        else:
                                            #check ScenarioInfo
                                            if PROJECT[PROJECT.lastIdx].rasterOutputCellSize != float(xmlQuery[0][CONFIG['ATTRIB']['RASTERCELLSIZE']]):
